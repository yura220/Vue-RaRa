...
<template>
              ...
              <ul class="d-lists">
                ...
                >
                  <div class="d-thumb-box">
                    <img :src="item.image" :alt="item.brand + ' 제품 이미지'" class="d-thumb" @click="handleProductClick(item)"/>
                  </div>
  ...
  <section id="item">
    <div class="wrap flex">
      <div class="i-layout">
        <div class="i-main">
          <img :src="weatherData.select[0].image" alt="" class="i-image" @click="handleProductClick(weatherData.select[0])"/>
        </div>
            ...
            <div class="vertical-group">
              <div v-for="slide in group" :key="slide.id" class="i-card">
                <div class="i-thumb-box">
                  <img :src="slide.image" class="i-thumb" :alt="slide.brand + ' 제품 이미지'" @click="handleProductClick(slide)" />
                </div>
                <div class="i-info" @click="handleProductClick(slide)">
